...
/***/ function(module, exports) {
	...
	Bank.prototype = {
	  ...
	  addInterest: function addInterest(amount) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InterestAdder = __webpack_require__(166);
	var AccountHacker = __webpack_require__(167);
	...
	var BankBox = React.createClass({
	  ...
	  handleInterestButton: function handleInterestButton(amount) {
	    var newBank = this.state.bank;
	    newBank.addInterest(amount);
	    this.setState({ bank: newBank });
	  },
	
	  handleAccountHack: function handleAccountHack(name) {
	    if (name === "Rick") {
	      return;
	    }
	    var newBank = this.state.bank;
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Total: £',
	        this.state.bank.totalCash().toFixed(2)
	      ),
	      React.createElement(AccountBox, { type: 'business', bank: bank, title: 'Business Accounts' }),
	      React.createElement(AccountBox, { type: 'personal', bank: bank, title: 'Personal Accounts' }),
	      React.createElement(InterestAdder, { value: 10, onButtonClick: this.handleInterestButton }),
	      React.createElement(AccountHacker, { onButtonClick: this.handleAccountHack })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4);
	var Bank = __webpack_require__(1);
	var AccountList = __webpack_require__(164);
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Total: £',
	        this.props.bank.totalCash(this.props.type).toFixed(2)
	      ),
	      React.createElement(AccountList, { type: this.props.type, bank: this.props.bank })
	    );
	  }
	});
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("input", { type: "number", defaultValue: 10, min: 0, max: 100 }),
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "form",
	        { onSubmit: this.handleClick },
	        React.createElement("input", { type: "text", defaultValue: "Enter Name" }),
	        React.createElement("input", { type: "submit", value: "Hack Account" })
	      )
	    );
	  }
	});
